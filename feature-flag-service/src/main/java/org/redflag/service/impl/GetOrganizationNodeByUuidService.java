...
public class GetOrganizationNodeByUuidService extends BaseService<OrganizationNodeUuidDTO, OrganizationNodeDTO> {
    ...
    @Override
    protected OrganizationNodeDTO execute(OrganizationNodeUuidDTO request) {
